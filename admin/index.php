        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 col-sm-6 col-md-6">
              <a class="text-dark" href="profil_pembudidaya.php">
                <div class="info-box mb-3">
                  <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-users"></i></span>

                  <div class="info-box-content">
                    <span class="text-xl">Pembudidaya</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
              </a>
            ...
            <div class="col-12 col-sm-6 col-md-6">
              <a class="text-dark" href="perhitungan.php">
                <div class="info-box mb-3">
                  <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-chart-column"></i></span>

                  <div class="info-box-content">
                    <span class="text-xl">Statistika</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
              </a>
